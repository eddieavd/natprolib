...
BENCHMARK( bm_range_sum< long long, std::vector < long long > > )->RangeMultiplier( 8 )->Range( 1024, 1024 << 16 )->Unit( benchmark::kMicrosecond );
BENCHMARK( bm_range_sum< long long, prefix_array< long long > > )->RangeMultiplier( 8 )->Range( 1024, 1024 << 16 )->Unit( benchmark::kMicrosecond );
BENCHMARK( bm_range_sum< long long, fenwick_tree< long long > > )->RangeMultiplier( 8 )->Range( 1024, 1024 << 16 )->Unit( benchmark::kMicrosecond );
BENCHMARK( bm_range_sum< long long, segment_tree< long long > > )->RangeMultiplier( 8 )->Range( 1024, 1024 << 16 )->Unit( benchmark::kMicrosecond );
